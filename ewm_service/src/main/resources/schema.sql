DROP TABLE IF EXISTS categories, users, events, requests, compilations, compilations_events, comments CASCADE;
...
CONSTRAINT fk_comments_events FOREIGN KEY (event_id) REFERENCES events(id) ON UPDATE CASCADE ON DELETE CASCADE,
CONSTRAINT fk_comments_users FOREIGN KEY (user_id) REFERENCES users(id) ON UPDATE CASCADE ON DELETE CASCADE
);